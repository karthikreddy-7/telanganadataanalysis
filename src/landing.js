  ...
  return (
    <>
      <header>
        ...
        <nav>
          <li>
            <button className="p-3" onClick={() => scrollToCards(1800)}>
              Analysis
            </button>
          </li>
          <li>
            <button className="p-3" onClick={() => scrollToCards(2500)}>
              About
            </button>
          </li>
          <li>
            <button className="p-3" onClick={() => scrollToCards(3500)}>
              Contact
            </button>
          </li>
        </nav>
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-2 mx-auto">
          ...
          <div class="flex flex-wrap -m-4 justify-center item-center">
              ...
              <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div class="flex-grow sm:pl-8">
                  ...
                  <h3 class="text-gray-500 mb-3">
                    Website Developer and Data Analyst
                  </h3>
                  <p class="mb-4">
